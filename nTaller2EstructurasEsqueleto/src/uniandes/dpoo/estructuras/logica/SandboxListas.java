...
public class SandboxListas
{
    ...
    {
        List<String> nuevalista = new ArrayList<String> (listaCadenas);
        return nuevalista;
    }
     ...
     * 
     * @param entero El valor que sea va a agregar.
     */
    ...
    public void volverPositivos( )
    {
    	...
    	for(int i=0 ; i < nuevalista.size() ; i++) {
    		int elementos = nuevalista.get(i);
    		listaEnteros.add(elementos);
    	}
    }
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for(String elem:listaCadenas) {
        	if (elem.toLowerCase().equals(cadena.toLowerCase())) {
        		buscado++;
        	}
        }
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	ArrayList<Integer> contado = new ArrayList<Integer>();
    	int x=0;
    	for(int i=0;i<listaEnteros.size();i++) {
    		int elemento = listaEnteros.get(i);
    		if (repetidos.contains(elemento)){
    			if (! contado.contains(elemento)) {
    				x++;
    				contado.add(elemento);
    			}
    		}else{
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for(int i = 0;i<cantidad;i++) {
    		int numero = (int) (minimo + Math.random()*(maximo-minimo));
